...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    public void InitializePool()
    {
        ...
        {
            nonPooledObjects[configObject.Prefab] = 0; //Sets initial value to 0
            RegisterPrefabInternal(configObject.Prefab, configObject.PrewarmCount);
            nonPooledObjects[configObject.Prefab] = 0; //Once all the prefabs have been registered internally, set the initial value to 0 again.
        }
